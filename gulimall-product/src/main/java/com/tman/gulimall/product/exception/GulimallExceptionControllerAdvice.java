package com.tman.gulimall.product.exception;

import com.tman.gulimall.common.exception.BizCodeEnum;
...
@Slf4j
@RestControllerAdvice(basePackages = "com.tman.gulimall.product.controller")
